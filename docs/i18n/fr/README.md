...
les outils d'écriture ; voir [la configuration de sécurité](security.md).
...
Ce dépôt fournit le gate Codex/Claude, les prompts, les trois skills et la documentation. Il ne contient volontairement pas les CLI Codex/Claude, leurs comptes, les valeurs de variables d'environnement, secrets ou réglages personnels de sandbox. Le détail complet est dans [l'architecture](workflow.md).
...
Lis [l'architecture](workflow.md), [le modèle de sécurité](security.md)
